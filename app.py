...
st.set_page_config(page_title="ReAG User Study", page_icon="🔬", layout="wide")
...
def show_login():
    ...
    st.title("🔬 Reasoning Trace Evaluation Study")
...
def show_evaluation(samples):
    ...
    with col_txt:
        ...
        with st.expander("📄 Retrieved Context", expanded=False):
            rel = "✅ Relevant" if sample['relevant'] else "❌ Irrelevant"
